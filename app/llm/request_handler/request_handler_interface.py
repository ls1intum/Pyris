...
class RequestHandler(BaseModel, metaclass=ABCMeta):
    ...
    @abstractmethod
    def chat(self, messages: list[any], arguments: CompletionArguments, tools: Optional[Sequence[Union[Dict[str, Any], Type[BaseModel], Callable, BaseTool]]]) -> PyrisMessage:
