...
def init():
    sentry_sdk.init(
        ...
        attach_stacktrace=os.environ.get("SENTRY_ATTACH_STACKTRACE", "False").lower() in ("true", "1"),
        max_request_body_size="always",
        enable_tracing=os.environ.get("SENTRY_ENABLE_TRACING", "False").lower() in ("true", "1"),
